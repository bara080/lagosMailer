...
export function isTransientSendError(msg) {
  ...
  return /(?:\b429\b|\b454\b|\b421\b|throttl|rate exceeded|maximum sending rate|too many requests|rate limit|timeout|timed out|econnreset|etimedout|socket|temporar|try again|service unavailable|throttling)/.test(s)
    || /\b5\d\d\b/.test(s);
}
